...
라이믹스 사이트의 메뉴 구조를 바탕으로 사이트맵(sitemap.xml)을 만들어 주는 모듈입니다.

**다른 사이트맵 모듈을 사용하시던 분은 rewrite 설정을 변경했던 것을 원래대로 되돌려 놓으시기 바랍니다.**
...
- 라이믹스를 서브디렉토리에 설치한 경우에도 사이트 루트에 sitemap.xml 파일을 생성할 수 있습니다.
